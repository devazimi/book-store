    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
      <div className="flex items-center h-16 md:h-20 gap-4 md:gap-6 lg:gap-10">
        ...
        <a href="#" className="flex items-center gap-2.5 flex-shrink-0 group">
          ...
          <span className="text-lg md:text-xl font-semibold text-gray-900 tracking-tight">کتاب‌خانه</span>
        </a>

        {/* لینک‌های دسکتاپ */}
        <div className="hidden lg:flex items-center gap-1">
          <a href="#" className="px-3 py-2 text-sm text-gray-600 hover:text-gray-900 transition-colors rounded-lg hover:bg-gray-50 font-medium">خانه</a>
          <a href="#" className="px-3 py-2 text-sm text-gray-600 hover:text-gray-900 transition-colors rounded-lg hover:bg-gray-50 font-medium">کتاب‌ها</a>
          <a href="#" className="px-3 py-2 text-sm text-gray-600 hover:text-gray-900 transition-colors rounded-lg hover:bg-gray-50 font-medium">دسته‌بندی</a>
          <a href="#" className="px-3 py-2 text-sm text-gray-600 hover:text-gray-900 transition-colors rounded-lg hover:bg-gray-50 font-medium">پرفروش‌ها</a>
        </div>
        ...
        <div className="flex items-center gap-1 md:gap-2">
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-gray-50 transition-colors relative">
            ...
            <span className="absolute top-1.5 right-1.5 w-4 h-4 bg-[#4b7995] text-white text-[10px] rounded-full flex items-center justify-center font-medium">۳</span>
          </button>
